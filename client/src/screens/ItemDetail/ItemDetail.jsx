  ...
  <Layout  user={props.user}>
    <div className="item-detail">
      ...
      <div className="detail">
        ...
        <div className="h4-text"><h4>Price </h4>${item.price}</div>
        <div className="h4-text"><h4>Shelf Life </h4>{item.shelfLife}</div>
        <div className="h4-text"><h4>Days Held </h4>{item.daysHeld}</div>
